...
const FOOTERNAME = '> SADEESHA - ＭＤ - Ｖ4';
global.owner = process.env.OWNER_NUMBER  || '94768211853' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=rM0QwZ6K#BUWCQDTHk4knAS5ALdx909iUUK2PBksBLoPOBCX1ZJA' ,
...
FOOTER: process.env.FOOTER || '‌👨‍💻 SADEESHA -ＭＤ - Ｖ5 👨‍💻',    
